...
//String copy method... returns size of final string, and stores result into char array passed. 
        ...
        size_t size)     /* I - Size of destination string buffer */
{
    ...
    /*
     * Figure out how much room is needed... Get the length of the source string. 
     */
...
JNIEXPORT jobject JNICALL Java_edu_cs300_MessageJNI_readPrefixRequestMsg(JNIEnv *env, jobject obj)
{
    ...
    // msgrcv to receive message
    int ret = msgrcv(msqid, &rbuf, sizeof(response_buf), 1, 0); //TODO what is the correct length here
    if (ret < 0)
    {
        int errnum = errno;
        fprintf(stderr, "Value of errno: %d\n", errno);
